...
<figure style="text-align: center;">
  <img src={TextWithMediaSection.src} alt="Beispiel eines Textes mit Medien" />

  <figcaption>
    <em>Beispiel eines Textes mit Medien</em>
  </figcaption>
</figure>
...
| Feature          | Text mit Medien             | Rich-Text        | Galerie        |
| ---------------- | --------------------------- | ---------------- | -------------- |
