...
description: Ein Inhaltsblock mit Tab-Navigation für strukturierte,
  ...
  in klaren Bereichen.
slug: de/1.0/components/tabs-section
---
...
Der **Tabs-Bereich** organisiert Inhalte in verschiedene Tabs mit Tab-Navigation. Er ist perfekt für strukturierte, kategorisierte Informationen, die von einer klaren, organisierten Präsentation profitieren, bei der nur ein Bereich gleichzeitig sichtbar ist.
...
* **Typ:** String
* **Erforderlich:** Ja
* **Zweck:** Hauptüberschrift für den gesamten Tabs-Bereich
* **Beispiel:**\
...
* **Typ:** Text
* **Erforderlich:** Nein
* **Zweck:** Beschreibung für den Tabs-Bereich
...
| Feature         | Tabs-Bereich     | Accordion-Bereich   |
| --------------- | ---------------- | ------------------- |
...
### Verwenden Sie Tabs-Bereich, wenn:
...
### Verwenden Sie Accordion-Bereich, wenn:
