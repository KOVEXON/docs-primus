...
Der **Bildslider-Bereich** ist ein flexibler Bildslider, der globale Inhalte (geteilt über alle Slides) mit slide-spezifischen Inhalten kombiniert. Mit Autoplay-Funktionalität und umfangreichen Konfigurationsoptionen ist er perfekt für die Erstellung dynamischer, ansprechender Präsentationen.

<Aside>
  **Ideal für:** Hero-Bereiche, Produktpräsentationen, Veranstaltungs-Highlights,
...
* **Seiten (`page`)**\
  Allgemeine Inhaltsseiten, insbesondere Hero-Bereiche und Produktseiten
