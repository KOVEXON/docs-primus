...
slug: de/1.0/components/feature-section
---
...
* **Typ:** String
* **Erforderlich:** Nein
* **Zweck:** Hauptüberschrift für den gesamten Feature-Bereich
* **Beispiele:**\
...
* **Typ:** Text
* **Erforderlich:** Nein
* **Zweck:** Beschreibung für den Feature-Bereich
* **Beispiel:**\
...
* **Typ:** Objekt
* **Erforderlich:** Nein
* **Zweck:** Call-to-Action-Button-Konfiguration für dieses Feature
* **Enthält:**
  * **Label:** Der Button-Text
  * **Link:** Die URL oder der Pfad, zu dem der Button verlinkt
* **Beispiel:**\
  `{ label: "Mehr erfahren", link: "/about-us" }`
...
* **Erforderlich:** Nein
* **Zweck:** Legt die Hintergrundfarbe für den gesamten Feature-Bereich fest
...
* CTA-Buttons sind einfache Objekte mit `label`- und `link`-Feldern
