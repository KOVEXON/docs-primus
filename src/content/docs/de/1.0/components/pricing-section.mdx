...
Der **Preis-Bereich** zeigt Preise, Pakete oder Angebote in organisierten Preis-Karten an. Jede Karte kann einen Namen, Preis, Beschreibung, Feature-Liste, optionale Buttons, Badges und Hervorhebung enthalten – perfekt für den Vergleich verschiedener Optionen und die Förderung von Conversions.
...
* **Typ:** String
* **Erforderlich:** Nein
* **Zweck:** Hauptüberschrift für den Preis-Bereich
* **Beispiel:**\
...
* **Typ:** Text
* **Erforderlich:** Nein
* **Zweck:** Beschreibung für den Preis-Bereich
* **Beispiel:**\
