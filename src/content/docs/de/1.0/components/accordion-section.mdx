...
<figure style="text-align: center;">
  <img src={AccordionSectionOverview.src} alt="Beispiel eines Accordions mit mehreren eingeklappten Elementen" />
...
<figure style="text-align: center;">
  <img src={AccordionSectionFields.src} alt="Die Accordion-Felder in Sanity Studio" />
