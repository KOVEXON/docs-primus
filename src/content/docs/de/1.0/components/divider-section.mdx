...
Der **Trennlinien-Bereich** ist ein minimaler Inhaltsblock, der visuelle Trennung oder Abstand zwischen anderen Inhaltsbereichen schafft.\
...
<figure style="text-align: center;">
  <img src={DividerSectionOverview.src} alt="Die Trennlinien-Bereich-Felder in Sanity Studio" />

  <figcaption>
    <em>Die Trennlinien-Bereich-Felder in Sanity Studio</em>
  </figcaption>
</figure>
