---
title: Hero-Bereich EINS
description: Ein spezialisierter Hero-Bereich mit flexiblen Überschriftenteilen,
  mehreren Stiloptionen, farbigen Schlüsselwörtern und Call-to-Action-Buttons.
slug: de/1.0/components/hero-section-one
---
...
Der **Hero-Bereich EINS** ist ein flexibler und visuell reichhaltiger Hero-Bereich, der darauf ausgelegt ist, starke erste Eindrücke zu schaffen.\
...
<Aside>
  **Ideal für:** Startseiten, Landing Pages und Marketing-Kampagnen, die
  starke visuelle Hierarchie, hervorgehobene Schlüsselwörter und prominente CTAs erfordern.
</Aside>
...
* **Typ:** Bild
* **Erforderlich:** Ja
* **Zweck:** Das Hintergrundbild des Hero-Bereichs
