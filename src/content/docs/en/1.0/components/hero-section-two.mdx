...
description: An alternative hero variant with headline, subheadline,
  description, and optional badge for clear, direct messaging.
slug: en/1.0/components/hero-section-two
---
