...
description: An image gallery with title, subtitle, and up to 20 images for
  showcasing products, events, or portfolios.
slug: en/1.0/components/image-gallery-section
---
...
<figure style="text-align: center;">
  <img src={ImageGallerySection.src} alt="Example of Image Gallery Section" />

  <figcaption>
    <em>Example of Image Gallery Section</em>
  </figcaption>
</figure>
