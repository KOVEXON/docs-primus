...
description: A flexible image slider with global and slide-specific content,
  autoplay, and navigation options for dynamic presentations.
slug: en/1.0/components/image-slider-section-one
---
